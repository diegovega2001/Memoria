...
DEFAULT_COLOR_JITTER_BRIGHTNESS = 0.4
DEFAULT_COLOR_JITTER_CONTRAST = 0.4
DEFAULT_COLOR_JITTER_SATURATION = 0.3
DEFAULT_COLOR_JITTER_HUE = 0.15
DEFAULT_ROTATION_DEGREES = 20
DEFAULT_RANDOM_PERSPECTIVE = 0.2
DEFAULT_RANDOM_ERASING_P = 0.3
...
DEFAULT_ARCFACE_SCALE = 64.0
DEFAULT_ARCFACE_MARGIN = 0.5
